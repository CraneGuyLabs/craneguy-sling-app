 ...
 *
 * BELOW-THE-HOOK ONLY
 * Hook height is informational / validation only and NEVER governs sling geometry.
 */
...
const MIN_SLING_ANGLE_DEG = 45; // bottom-of-hook / bottom-of-bar
...
export function calculateSling(
  ...
  return {
    ...
    blocked: false,
    summary: {
      governing_condition: governingCondition,
